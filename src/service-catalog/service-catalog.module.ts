...
import { InternalServiceCatalogController } from "./infrastructure/controllers/internal-service-catalog.controller";
...
@Module({
  ...
  controllers: [ServiceCatalogController, InternalServiceCatalogController],
  providers: [
